...
class Category(models.Model):
    ...
    slug = models.SlugField(max_length=120, unique=True, help_text="Unique slug for the category.")
...
class Product(models.Model):
    ...
    trademark = models.ForeignKey(Trademark, on_delete=models.PROTECT, related_name="products")
...
class Customer(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name="customer_profile_ecommerce")
...
class Metadata(models.Model):
    product = models.OneToOneField(Product, on_delete=models.CASCADE, related_name="meta_data")
...
class ProductFeature(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name="features_list")
