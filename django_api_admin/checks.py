...
from django_api_admin.exceptions import NotRelationField, NotRegistered
...
class BaseAPIModelAdminChecks:
    def check(self, admin_obj, **kwargs):
        return [
            ...
            *self._check_serializer_class(admin_obj),
    ...
    def _check_fields(self, obj):
        ...
        if obj.fields is None:
            ...
            return must_be("a list or tuple", option="fields", obj=obj, id="api_admin.E004")
        elif obj.fieldsets:
            return [
                checks.Error(
    ...
    def _check_fieldsets_item(self, obj, fieldset, label, seen_fields):
        ...
        if not isinstance(fieldset, (list, tuple)):
            return must_be("a list or tuple", option=label, obj=obj, id="api_admin.E008")
        elif len(fieldset) != 2:
    ...
    def _check_radio_fields_value(self, obj, val, label):
        ...
        from django_api_admin.admins.model_admin import HORIZONTAL, VERTICAL
    ...
    def _check_prepopulated_fields_value(self, obj, val, label):
        ...
        if not isinstance(val, (list, tuple)):
            return must_be("a list or tuple", option=label, obj=obj, id="api_admin.E029")
        else:
            return list(
                chain.from_iterable(
...
class APIModelAdminChecks(BaseAPIModelAdminChecks):
    ...
    def _check_save_as(self, obj):
        ...
        if not isinstance(obj.save_as, bool):
            return must_be("a boolean", option="save_as", obj=obj, id="api_admin.E101")
        else:
            return []
    ...
    def _check_save_on_top(self, obj):
        ...
        if not isinstance(obj.save_on_top, bool):
            return must_be("a boolean", option="save_on_top", obj=obj, id="api_admin.E102")
        else:
            return []
    ...
    def _check_inlines_item(self, obj, inline, label):
        ...
        try:
            ...
            return [
                checks.Error(
                    "'%s' must inherit from 'InlineAPIModelAdmin'." % obj,
                    obj=obj.__class__,
                    id="api_admin.E104",
                )
            ]
