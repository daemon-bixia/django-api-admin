...
CORE_FIELD_ATTRIBUTES = [
    ...
    "allow_null", "label", "help_text",  "initial",
    "style",
]

STRING_FIELDS_ATTRIBUTES = [
    "max_length", "min_length", "allow_blank",
    "trim_whitespace"
]
...
CHOICE_FIELDS_ATTRIBUTES = [
    "choices", "allow_blank", "html_cutoff",
    "html_cutoff_text"
]
...
SERIALIZER_FIELD_ATTRIBUTES = {
    ...
    "DecimalField": [*CORE_FIELD_ATTRIBUTES, *NUMERIC_FIELDS_ATTRIBUTES, "max_digits", "decimal_places",
                     "coerce_to_string", "localize", "rounding", "normalize_output"],
